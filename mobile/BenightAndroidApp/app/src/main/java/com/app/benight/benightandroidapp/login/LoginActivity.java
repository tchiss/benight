package com.app.benight.benightandroidapp.login;
...
import com.app.benight.benightandroidapp.passwordRecovery.PasswordRecoveryActivity;
import com.app.benight.benightandroidapp.register.RegisterActivity;
...
public class LoginActivity extends FragmentActivity {
    ...
    protected ImageView logoBenight;
    protected EditText  mUsername;
    protected EditText  mPassword;
    protected TextView  mForgotPasswordLink;
    protected Button    mLoginBtn;
    protected TextView  mCreateAccountBtn;
...
//        ParseObject.registerSubclass(ParseUser.class);
        ...
        // Initialize
        logoBenight = (ImageView)findViewById(R.id.logoBenightLogin);
        ...
        mCreateAccountBtn = (TextView)findViewById(R.id.createAccountBtnLogin);
        mForgotPasswordLink = (TextView)findViewById(R.id.forgotPasswordLink);
        // Set logo benight
        logoBenight.setImageResource(R.drawable.benight_login_logo);
            ...
            public void onClick(View v) {
                ...
                ParseUser.logInInBackground(username, password, new LogInCallback() {
                    ...
                    public void done(ParseUser parseUser, ParseException e) {
                        if (e == null) {
                            // success
                            Toast.makeText(LoginActivity.this, R.string.title_welcome, Toast.LENGTH_LONG).show();
        ...
        mForgotPasswordLink.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent takeUserPasswordRecovery = new Intent(LoginActivity.this, PasswordRecoveryActivity.class);
                startActivity(takeUserPasswordRecovery);
            }
        });
    }
