...
((__t = ( phone )) == null ? '' : __t) +
'</div>\r\n    \t</div>\r\n        <button type="submit" class="btn btn-success-outline edit" style="background-color: #38d07d; color: white; font-weight: bold;">Modifier</button>\r\n    </div>\r\n</div>';

}
return __p
};

this["JST"]["app/scripts/templates/accountEdit.ejs"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["app/scripts/templates/newsCollection.ejs"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<ul class="events">\r\n\t<span>' +
